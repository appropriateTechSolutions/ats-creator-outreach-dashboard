      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-500 font-medium mt-1 flex items-center gap-2">
            <ShoppingBag size={18} className="text-primary-600" /> Managed brand identities and campaign grouping.
          </p>
        </div>
        <Button 
              ...
              {loading ? (
                <tr>
                  <td colSpan={5} className="px-8 py-20 text-center">
                    ...
                    <p className="text-gray-400 font-normal">Synchronizing Brand Data...</p>
                  </td>
                </tr>
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-white shadow-lg border border-gray-100 flex items-center justify-center text-primary-600 group-hover:scale-110 transition-transform">
                          <ShoppingBag size={24} />
                        </div>
                        <div>
              ...
              <form id="brand-form" onSubmit={handleCreateBrand} className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-6">
                     <h3 className="text-xs font-bold text-primary-600 uppercase tracking-widest flex items-center gap-2 mb-2 font-outfit">
                       <Building2 size={14} /> Core Identity
                     </h3>
                     <div className="space-y-1.5">
                       <label className="text-sm font-medium text-gray-600 font-outfit">Parent Agency</label>
                       <select
                         required
                  ...
                  <div className="space-y-6">
                     <h3 className="text-xs font-bold text-primary-600 uppercase tracking-widest flex items-center gap-2 mb-2 font-outfit">
                       <Tag size={14} /> Market Positioning
                     </h3>
                     <Input
                     ...
                     />
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                           <label className="text-sm font-medium text-gray-600 font-outfit">Default Commission (%)</label>
                        ...
                        <div className="space-y-1.5">
                           <label className="text-sm font-medium text-gray-600 font-outfit">Brand Status</label>
                           <select
                ...
                <div className="space-y-6">
                   <h3 className="text-xs font-bold text-primary-600 uppercase tracking-widest flex items-center gap-2 font-outfit">
                     <Target size={14} /> Brand Intelligence
                   </h3>
                   <div className="grid grid-cols-2 gap-8">
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-600 font-outfit">Brand Description</label>
                        <textarea
                      ...
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-600 font-outfit">Target Audience</label>
                        <textarea
                ...
                <div className="space-y-6">
                   <h3 className="text-xs font-bold text-primary-600 uppercase tracking-widest flex items-center gap-2 font-outfit">
                     <Megaphone size={14} /> Operational Parameters
                   </h3>
                   <div className="grid grid-cols-2 gap-8">
                      <Input
                        label="Brand Voice"
                   ...
                   <div className="grid grid-cols-2 gap-8">
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-600 font-outfit">Affiliate & Commission Terms</label>
                        <textarea
                      ...
                      <div className="space-y-1.5">
                        <label className="text-sm font-medium text-gray-600 font-outfit">Product Offer Notes</label>
                        <textarea
                ...
                <div className="space-y-1.5 pb-4">
                   <label className="text-sm font-medium text-gray-600 font-outfit">Notes</label>
                   <textarea
