...
export default function ClientDetail() {
  ...
  const { data: client, isLoading: loading, refetch: fetchClientData } = useClient(id);
  ...
  // Keep the edit form in sync with the loaded client.
  useEffect(() => {
  ...
  const handleUpdateStatus = async (newStatus: string) => {
    ...
    if (client) {
      queryClient.setQueryData(queryKeys.clients.detail(id!), { ...client, status: newStatus });
    }
    ...
    try {
      ...
      logger.error(err);
      toast.error(`Failed to update client status to ${newStatus}`);
  ...
  if (!client) {
    return (
      <div className="p-20 text-center">
        ...
        <Link to="/clients" className="text-primary-600 font-normal mt-4 inline-block">
          Back to Clients
        </Link>
      </div>
    );
              ...
              <div className="flex items-center gap-3">
                ...
                {hasRole(currentUser?.role, ROLE_GROUPS.ADMINS) && (
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() =>
                        handleUpdateStatus(client.status === 'active' ? 'inactive' : 'active')
                      }
                    ...
                    <span
                      className={`text-[10px] font-bold uppercase tracking-widest ${client.status === 'active' ? 'text-primary-600' : 'text-gray-400'}`}
                    >
      ...
      <Card className="border-none shadow-2xl bg-white overflow-hidden">
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-gray-100">
          <div className="space-y-6 pb-6 md:pb-0">
            <div>
              <h4 className="text-[10px] font-normal text-gray-400 uppercase tracking-widest mb-1.5">
                Legal Identity
              </h4>
              <p className="text-gray-900 font-normal text-lg">
                {client.legal_name || 'Not provided'}
              </p>
            </div>
            <div>
              <h4 className="text-[10px] font-normal text-gray-400 uppercase tracking-widest mb-1.5">
          ...
          <div className="md:pl-8 space-y-6 py-6 md:py-0">
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-primary-600 font-normal flex items-center gap-2 hover:underline truncate"
              >
          ...
          <div className="lg:pl-8 space-y-6 pt-6 lg:pt-0">
            <div>
              ...
              <p className="text-gray-900 font-normal">
                {client.primary_contact_name || 'Unassigned'}
              </p>
              <div className="space-y-2 mt-3">
                <div className="flex items-center gap-2 text-xs text-gray-500 font-normal">
                  ...
                  <span className="truncate">{client.primary_contact_email || 'No email'}</span>
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-500 font-normal">
                  <Phone size={14} className="text-primary-400 shrink-0" />{' '}
                  {client.primary_contact_phone || 'No phone'}
                </div>
              </div>
            </div>
          </div>
      ...
      <Card className="border-none shadow-2xl overflow-hidden bg-white">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {hasRole(currentUser?.role, ROLE_GROUPS.MARKETING_AND_ADMINS) && (
              <Button
                size="sm"
            ...
            <tbody className="divide-y divide-gray-50">
              {client.brands?.length === 0 ? (
                <tr>
                  <td
                    colSpan={4}
                    className="px-8 py-16 text-center text-gray-400 italic font-normal"
                  >
                  ...
                  >
                    ...
                    <td className="px-8 py-5">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-sm font-normal text-gray-500 hover:text-primary-600 flex items-center gap-1.5 transition-colors"
                  ...
                  <tr key={user.id} className="hover:bg-primary-50/30 transition-colors group">
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-normal text-gray-900 leading-tight font-outfit uppercase tracking-tight">
                            {user.full_name}
                          </div>
        ...
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-4xl max-h-[90vh] overflow-hidden p-0 border-none shadow-3xl animate-in zoom-in-95 duration-200 bg-white flex flex-col">
            <div className="p-8 border-b border-gray-100 flex justify-between items-center bg-white shrink-0">
              <div>
                ...
                <p className="text-slate-400 text-[10px] font-light mt-1 uppercase tracking-widest font-outfit leading-relaxed">
                  Update agency identity and service parameters.
                </p>
              </div>
              <button
                  ...
                  <div className="p-6 bg-slate-50/50 rounded-2xl border border-slate-100/50 space-y-6">
                    <div className="grid grid-cols-2 gap-8 items-start">
                      <Input
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, primary_contact_name: e.target.value })
                        }
                      />
                      <Input
                        label="Work Email"
                  ...
                  <div className="grid grid-cols-3 gap-6 items-start">
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, plan_type: e.target.value })
                        }
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setEditFormData({ ...editFormData, billing_status: e.target.value })
                        }
                        className="w-full bg-white/50 backdrop-blur-sm border border-slate-200 rounded-xl py-2.5 px-4 text-slate-900 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-outfit"
                      >
            ...
            <div className="p-8 border-t border-gray-100 bg-white rounded-b-2xl shrink-0 flex gap-4">
              <Button
                variant="ghost"
                className="flex-1 font-light uppercase tracking-widest text-[10px] font-outfit"
                onClick={() => setIsEditModalOpen(false)}
              >
                Cancel
              </Button>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
              <form id="brand-form" onSubmit={handleCreateBrand} className="space-y-8">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-8 items-start">
                    <div className="space-y-1.5">
                      <span className="text-xs font-light text-slate-500 block font-outfit uppercase tracking-widest">
                        Parent Agency
                      </span>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewBrandFormData({ ...newBrandFormData, industry: e.target.value })
                      }
                  ...
                  <div className="grid grid-cols-2 gap-8 items-start">
                    <Input
                      ...
                      onChange={(e) =>
                        setNewBrandFormData({ ...newBrandFormData, name: e.target.value })
                      }
                  ...
                  <div className="grid grid-cols-2 gap-8 items-start">
                    <Input
                      ...
                      onChange={(e) =>
                        setNewBrandFormData({ ...newBrandFormData, website: e.target.value })
                      }
                    ...
                    <div className="grid grid-cols-2 gap-4 items-start">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setNewBrandFormData({ ...newBrandFormData, status: e.target.value })
                          }
                          className="w-full bg-white/50 backdrop-blur-sm border border-slate-200 rounded-xl py-2.5 px-4 text-slate-900 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-outfit"
                        >
                          <option value="active">Active</option>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-8 items-start">
                    <Input
                      ...
                      onChange={(e) =>
                        setNewBrandFormData({ ...newBrandFormData, brand_voice: e.target.value })
                      }
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewBrandFormData({ ...newBrandFormData, restrictions: e.target.value })
                      }
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setNewBrandFormData({
                            ...newBrandFormData,
                            affiliate_terms: e.target.value,
                          })
                        }
                        className="w-full bg-white/50 backdrop-blur-sm border border-slate-200 rounded-xl p-4 text-sm font-normal text-slate-900 h-24 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-outfit placeholder:text-slate-400"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          setNewBrandFormData({
                            ...newBrandFormData,
                            product_offer_notes: e.target.value,
                          })
                        }
                        className="w-full bg-white/50 backdrop-blur-sm border border-slate-200 rounded-xl p-4 text-sm font-normal text-slate-900 h-24 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all font-outfit placeholder:text-slate-400"
                ...
                <div className="space-y-1.5 pb-4">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewBrandFormData({ ...newBrandFormData, notes: e.target.value })
                    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <Card className="w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200 bg-white">
            ...
            <form onSubmit={handleSubmitInvite} className="p-6 space-y-5">
              <div className="space-y-1.5">
                <label
                  htmlFor="clientdetail-2002"
                  className="text-xs font-light text-gray-500 font-outfit uppercase tracking-widest mb-1.5"
                >
                  Full Name
                </label>
                <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <span className="text-xs font-light text-gray-500 font-outfit uppercase tracking-widest mb-1.5">
                    User Type
                  </span>
              ...
              <div className="flex gap-3 pt-2">
                <Button
                  type="button"
                  variant="outline"
                  className="flex-1 font-outfit font-light text-[10px] uppercase tracking-widest"
                  onClick={() => setIsInviteModalOpen(false)}
                >
                  Cancel
                </Button>
