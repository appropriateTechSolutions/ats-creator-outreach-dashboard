              ...
              <Card key={camp.id} className="group hover:border-primary-200 transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <h3 className="text-lg font-normal text-gray-900 group-hover:text-primary-600 transition-colors font-outfit uppercase tracking-tight">{camp.name}</h3>
                      <div className="flex items-center gap-2 mt-1">
                        <span className={`w-2 h-2 rounded-full ${camp.status === 'active' ? 'bg-success-500 animate-pulse' : 'bg-gray-300'}`} />
                        <span className="text-xs font-normal text-gray-400 uppercase tracking-wider">{camp.status}</span>
                      </div>
                    </div>
                    <div className="text-right">
                        <div className="text-2xl font-normal text-gray-900">{Math.round(camp.progress)}%</div>
                        <div className="text-[10px] font-normal text-gray-400 uppercase tracking-widest">Completion</div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gray-50 rounded-xl p-3 border border-gray-100">
                       <p className="text-[10px] font-normal text-gray-400 uppercase mb-1 tracking-widest">Target</p>
                    ...
                    <div className="bg-success-50/30 rounded-xl p-3 border border-success-100/50">
                       <p className="text-[10px] font-normal text-success-600/60 uppercase mb-1 tracking-widest">Delivered</p>
                    ...
                    <div className="bg-primary-50/30 rounded-xl p-3 border border-primary-100/50">
                       <p className="text-[10px] font-normal text-primary-600/60 uppercase mb-1 tracking-widest">Pending</p>
