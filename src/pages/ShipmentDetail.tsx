...
import { useShipment } from '../hooks/queries';
import { Package, Truck, Edit3, ExternalLink, ArrowLeft, Calendar } from 'lucide-react';
...
export default function ShipmentDetail() {
  ...
  const { data: shipment, isLoading: loading, refetch: fetchShipment } = useShipment(id);
  ...
  if (!shipment) {
    return (
      <div className="py-20 max-w-7xl mx-auto px-4 sm:px-0 text-center">
        ...
        <Link
          to={fromCreatorId ? `/creators/${fromCreatorId}` : '/shipments'}
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-20 px-4 sm:px-0 animate-[fadeIn_0.2s_ease]">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {shipment.status === 'pending' && (
            <Button
              className="bg-primary-600 hover:bg-primary-700 text-white font-medium capitalize text-sm min-h-[40px] px-6 shadow-sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border-b border-gray-100 pb-6">
              <div className="flex items-center gap-4">
                <CreatorAvatar
                  ...
                  className="w-16 h-16 rounded-full bg-primary-100 text-primary-700 flex flex-shrink-0 items-center justify-center font-normal text-2xl uppercase ring-4 ring-white shadow-md overflow-hidden"
                />
                <div>
                  ...
                  <div className="text-xs text-gray-400 mt-0.5">
                    {shipment.Creator?.email || 'No email registered'}
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6">
              ...
              <div className="space-y-4 font-outfit">
                <div className="space-y-3">
                  <div>
                    <span className="text-[9px] font-normal text-gray-400 uppercase tracking-wider block">
                      Product Name
                    </span>
              ...
              <div className="space-y-4 font-outfit">
                <div className="space-y-3">
                  <div>
                    ...
                    <span className="text-sm font-normal text-gray-800">
                      {shipment.recipient_name || 'No Name'}
                    </span>
                  </div>
                  <div>
                    <span className="text-[9px] font-normal text-gray-400 uppercase tracking-wider block">
                    ...
                    <div className="text-sm text-gray-800 font-normal leading-relaxed bg-gray-50/50 border border-gray-100 rounded-xl p-3">
                      ...
                      {shipment.shipping_address_line2 && (
                        <div>{shipment.shipping_address_line2}</div>
                      )}
                      <div>
                        {shipment.shipping_city}, {shipment.shipping_state} {shipment.shipping_zip}
                      </div>
                      <div className="text-gray-400 uppercase tracking-wider text-[10px] mt-1">
            ...
            <div className="border-t border-gray-100 mt-6 pt-6 space-y-6">
                ...
                <div className="space-y-4 font-outfit">
                  ...
                  {shipment.tracking_number ? (
                    <div className="space-y-3 bg-gray-50/50 border border-gray-100 rounded-xl p-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <span className="font-normal text-gray-800 uppercase text-xs">
                            {shipment.carrier || '---'}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="font-normal text-gray-800 font-mono text-xs">
                            {shipment.tracking_number}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="text-sm text-gray-400 italic">
                      No tracking information added yet. Click edit to add tracking details.
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4 font-outfit">
                  ...
                  <div className="space-y-2 text-xs font-mono">
                    <div className="flex justify-between items-center py-1.5 border-b border-gray-50">
                      ...
                      <span className="text-gray-750 font-normal">
                        {shipment.createdAt
                          ? format(new Date(shipment.createdAt), 'MMM d, yyyy h:mm a')
                          : '---'}
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-1.5 border-b border-gray-50">
              ...
              {shipment.notes && (
                <div className="bg-yellow-50/45 border border-yellow-100/50 p-4 rounded-xl font-outfit">
                  <span className="text-[9px] font-normal text-amber-800 uppercase tracking-wider block">
                    Shipment Notes
                  </span>
                  <p className="text-sm text-gray-650 mt-1 whitespace-pre-wrap leading-relaxed">
                    {shipment.notes}
                  </p>
                </div>
              )}
        ...
        <div className="space-y-8 lg:col-span-1">
          ...
          <Card className="border-none shadow-xl bg-white p-6">
            <h3 className="text-sm font-normal text-gray-700 uppercase tracking-widest mb-6 font-outfit">
              Delivery Timeline
            </h3>
            ...
            <div className="relative pl-6 space-y-8 font-outfit before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-100">
              ...
              <div className="relative">
                <div
                  className={`absolute -left-[20px] top-1 w-[12px] h-[12px] rounded-full border-2 bg-white ${
                    currentStatusIndex >= 0 ? 'border-indigo-600 bg-indigo-600' : 'border-gray-300'
                  }`}
                />
                <div>
                  <h4 className="text-xs font-normal text-gray-800 uppercase tracking-wide">
                    Shipment Registered
                  </h4>
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    Shipment created for campaign dispatch.
                  </p>
                  {shipment.createdAt && (
              ...
              <div className="relative">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    Package dispatched via carrier.
                  </p>
                  {shipment.shipped_at && (
                    <span className="text-[9px] text-indigo-600 font-mono mt-1 block">
              ...
              <div className="relative">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    Package arrived at recipient destination.
                  </p>
                  {shipment.delivered_at && (
          ...
          <Card className="border-none shadow-xl bg-white p-6 space-y-4 font-outfit">
            <h3 className="text-sm font-normal text-gray-700 uppercase tracking-widest">
              Linked Campaign
            </h3>
            <div>
              ...
              <span className="text-sm font-normal text-gray-800 block mt-0.5">
      ...
      <Modal
        ...
        title="Update Shipment Details & Tracking"
      >
        <form onSubmit={submitEdit} className="space-y-4 font-outfit">
          ...
          <div className="space-y-2">
            <h4 className="text-[10px] font-bold uppercase tracking-wider text-gray-700 mt-2 border-b border-gray-100 pb-1">
              Delivery Address
            </h4>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="shipmentdetail-6"
                  className="block text-[9px] font-normal uppercase tracking-wider text-gray-450 mb-1"
                >
                  Address Line 1
                </label>
                <input
              ...
              <div>
                <label
                  htmlFor="shipmentdetail-10"
                  className="block text-[9px] font-normal uppercase tracking-wider text-gray-450 mb-1"
                >
                  Zip Code
                </label>
                <input
                  id="shipmentdetail-10"
                  type="text"
                  required
                  placeholder="Zip"
              ...
              <div>
                <label
                  htmlFor="shipmentdetail-11"
                  className="block text-[9px] font-normal uppercase tracking-wider text-gray-450 mb-1"
                >
                  Country
                </label>
                <input
                  id="shipmentdetail-11"
                  type="text"
                  required
          ...
          <div>
            <label
              htmlFor="shipmentdetail-12"
              className="block text-[10px] font-normal uppercase tracking-wider text-gray-500 mb-1"
            >
              Shipment Notes
            </label>
            <textarea
              id="shipmentdetail-12"
              rows={2}
