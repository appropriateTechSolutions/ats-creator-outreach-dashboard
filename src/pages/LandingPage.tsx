...
export default function LandingPage() {
  ...
  const contactedCount = creators.filter(
    (c) => c.status === 'contacted' || c.status === 'replied',
  ).length;
  const replyRate =
    contactedCount > 0
      ? ((creators.filter((c) => c.status === 'replied').length / contactedCount) * 100).toFixed(0)
      : '0';
    ...
    <div className="bg-[#070a13] text-gray-100 min-h-screen font-sans overflow-x-hidden selection:bg-primary-500/30 selection:text-primary-200">
      ...
      <section className="relative pt-24 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 font-light leading-relaxed">
          The ultimate engine built for agencies to automatically search creators, enrich emails,
          send multi-stage campaigns, and track conversions.
        </p>
      ...
      <div className="border-y border-[#101726]/80 bg-[#070a13]/40 py-10 my-10 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl sm:text-4xl font-normal font-outfit text-primary-400">
                5M+
              </div>
              <div className="text-xs text-gray-505 uppercase tracking-widest mt-1">
                Verified Creators
              </div>
            </div>
            <div>
            ...
            <div>
              <div className="text-3xl sm:text-4xl font-normal font-outfit text-success-400">
                15x
              </div>
              <div className="text-xs text-gray-550 uppercase tracking-widest mt-1">
                Average Campaign ROI
              </div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-normal font-outfit text-warning-400">
                500k+
              </div>
              <div className="text-xs text-gray-500 uppercase tracking-widest mt-1">
                Automated Mails Sent
              </div>
            </div>
          </div>
        </div>
      ...
      <section
        id="demo"
        className="py-20 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 scroll-mt-20"
      >
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2 max-w-lg mx-auto font-light">
            No placeholder images. Experience the exact layout, fields, and colored letter badges
            used in our live system.
          </p>
        </div>
        ...
        <div className="bg-[#0f1524]/60 border border-[#1e293b]/80 rounded-2xl p-6 shadow-2xl backdrop-blur-sm transition-all hover:border-[#2563eb]/30">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              <h3 className="text-lg font-medium text-gray-100 uppercase tracking-widest font-outfit text-left">
                Live Campaign Preview
              </h3>
              <p className="text-xs text-primary-400 font-medium text-left mt-0.5">
                Filter by review status to test interactions
              </p>
            </div>
              ...
              {filterOpen && (
                <>
                  <div
                    ...
                    {...dismissOverlay(() => setFilterOpen(false))}
                  ></div>
                  <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#070a13] border border-[#1e293b] p-3 shadow-xl z-20 space-y-2.5">
                    {['discovered', 'pending_review', 'approved', 'contacted', 'replied'].map(
                      (status) => (
                        <label
                          key={status}
                          className="flex items-center gap-3 cursor-pointer text-xs font-medium text-gray-300 hover:text-gray-100 transition-colors uppercase tracking-wider select-none"
                        >
                          <input
                            type="checkbox"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-[#070a13] border border-[#162035] p-5 rounded-2xl flex flex-col justify-between hover:border-[#1e293b] transition-colors text-left">
              <div>
                <p className="text-[10px] font-bold text-gray-405 uppercase tracking-widest mb-1">
                  Creators Tracked
                </p>
                ...
                <tbody className="divide-y divide-[#101726]">
                  {filteredCreators.length === 0 ? (
                    <tr>
                      <td
                        colSpan={6}
                        className="px-6 py-12 text-center text-gray-500 font-light text-sm"
                      >
                      ...
                      <tr key={creator.id} className="hover:bg-[#0f1524]/30 transition-colors">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <div
                              className={`w-9 h-9 rounded-full border flex items-center justify-center font-bold text-xs uppercase ${creator.avatarBg}`}
                            >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-2xs font-semibold uppercase tracking-wider ${
                              creator.status === 'replied'
                                ? 'bg-success-600/20 text-success-400 border border-success-500/20'
                                : creator.status === 'contacted'
                                  ? 'bg-primary-600/20 text-primary-400 border border-primary-500/20'
                                  : creator.status === 'approved'
                                    ? 'bg-warning-600/20 text-warning-400 border border-warning-500/20'
      ...
      <section
        id="how-it-works"
        className="py-20 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-[#101726]/80 scroll-mt-20"
      >
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-2 max-w-xl mx-auto font-light">
            ATS Outreach is designed to automate your entire influencer marketing process in 5
            simple steps.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
          ...
          <div className="bg-[#0f1524]/20 border border-[#101726]/60 p-6 rounded-2xl relative text-left flex flex-col justify-between hover:border-[#1e293b] transition-colors">
            <div>
              ...
              <h3 className="text-sm font-semibold text-gray-100 font-outfit uppercase tracking-wider mb-2">
                1. Set Up Campaigns
              </h3>
              <p className="text-xs text-gray-400 font-light leading-relaxed">
                Create a campaign for your brand by filling out simple details. Tell the system what
                kind of influencers you are looking for (like travel, fitness, tech) and where they
                should be located (like Austin, Texas).
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0f1524]/20 border border-[#101726]/60 p-6 rounded-2xl relative text-left flex flex-col justify-between hover:border-[#1e293b] transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-400 font-light leading-relaxed">
                The system goes to work in the background. It searches social platforms,
                automatically finds creator handles, validates their emails, and calculates match
                scores so you only get relevant leads.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0f1524]/20 border border-[#101726]/60 p-6 rounded-2xl relative text-left flex flex-col justify-between hover:border-[#1e293b] transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-400 font-light leading-relaxed">
                Your team can review creators in a clean queue list. See their statistics, social
                links, and check their fit. Approve them to start outreach, reject them, or
                shortlist them for later.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0f1524]/20 border border-[#101726]/60 p-6 rounded-2xl relative text-left flex flex-col justify-between hover:border-[#1e293b] transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-400 font-light leading-relaxed">
                The platform automatically sends out professional email sequences using your
                client's customized brand email. It also copies Instagram direct message templates
                to your clipboard for quick social outbounding.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#0f1524]/20 border border-[#101726]/60 p-6 rounded-2xl relative text-left flex flex-col justify-between hover:border-[#1e293b] transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-400 font-light leading-relaxed">
                When creators schedule a call, it syncs directly with the built-in calendar. Once
                approved as partners, you can assign custom discount codes/links and track how many
                sales they generate automatically.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-2 max-w-md mx-auto font-light">
            Everything your team needs to discovery, vet, and outreach influencers in a structured
            automated engine.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <h3 className="text-lg font-medium text-gray-100 font-outfit uppercase tracking-widest mb-2">
              Smart Creator Search
            </h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Find the perfect influencers for your brand in seconds. Search by location, category,
              and bio keywords. Our AI automatically gathers their public emails and profiles.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <h3 className="text-lg font-medium text-gray-100 font-outfit uppercase tracking-widest mb-2">
              Dedicated Client Emails
            </h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Send outreach emails using your client's custom brand email addresses. Keeps your
              message delivery high and ensures creators receive professional emails.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <h3 className="text-lg font-medium text-gray-100 font-outfit uppercase tracking-widest mb-2">
              Vetting & Approval Queue
            </h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Easily review and filter discovered influencers. Approve, reject, or shortlist
              creators with a single click and see instant status updates.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <h3 className="text-lg font-medium text-gray-100 font-outfit uppercase tracking-widest mb-2">
              Direct Email & DM Outreach
            </h3>
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Chat with creators directly from a single unified inbox. Automatically copy custom
              Instagram DM templates to your clipboard for quick social outbounding.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Track creator call bookings automatically. Review meeting logs, schedule dates, and
              notes to seamlessly onboard creators as brand partners.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Assign and monitor discount codes and referral links for each influencer. View charts
              of real-time sales revenue, conversions, and payouts.
            </p>
          </div>
          ...
          <div className="bg-[#0f1524]/40 border border-[#101726] p-6 rounded-2xl hover:border-[#1e293b] transition-all hover:-translate-y-1 text-left">
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed">
              Manage multiple clients and brands under one dashboard. Customise campaign rules,
              creative details, and commercial terms individually.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        id="about"
        className="py-20 relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-[#101726]/80 scroll-mt-20 text-center"
      >
        <div className="mb-12">
          <h2 className="text-3xl font-normal font-outfit uppercase tracking-wider text-gray-100">
            About ATS Outreach
        ...
        <div className="space-y-6 text-gray-400 font-light text-sm sm:text-base leading-relaxed text-center max-w-2xl mx-auto">
          <p>
            Appropriate Tech Solutions (ATS) is dedicated to helping agencies and brands streamline
            creator partnerships. We believe that influencer marketing shouldn't require hundreds of
            hours of manual work.
          </p>
          <p>
            Our platform eliminates the tedious tasks of hunting for profiles, validating business
            email addresses, managing outreach sequences, and calculating commission returns
            manually. We build simple, robust, and scalable solutions that bridge the gap between
            creative brands and top-tier content creators.
          </p>
          <p>
            Whether you are a growing marketing agency or a global brand, ATS Outreach is built to
            help you automate, optimize, and scale your outreach operations safely and securely.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-[#101726]/80 text-center relative">
        <div className="bg-gradient-to-r from-primary-950/40 via-blue-950/40 to-[#070a13] border border-[#1e293b]/20 rounded-3xl py-12 px-6 sm:px-12 relative overflow-hidden shadow-2xl">
          ...
          <p className="text-gray-400 max-w-lg mx-auto font-light text-sm sm:text-base mb-8 relative z-10">
            Onboard your clients, find highly-relevant influencers, send automated email sequences,
            and track sales commission today.
          </p>
      ...
      <footer className="bg-[#070a13] border-t border-[#101726]/80 py-12 text-gray-500 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            {/* eslint-disable-next-line jsx-a11y/anchor-is-valid -- placeholder link; legal pages pending */}
