...
const CreatorCampaignContentDetail = React.lazy(() => import('./pages/CreatorCampaignContentDetail'));
  ...
  return (
    <ToastProvider>
      <ConfirmProvider>
        <AuthProvider>
          <Router>
        <Suspense fallback={<div className="h-screen w-screen flex items-center justify-center bg-gray-50"><LoadingState message="Loading page..." /></div>}>
          <Routes>
