...
export function ShipmentModal({
  ...
  const submitShipment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Failed to create shipment: ' + err);
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Dispatched Product Shipment" size="lg">
      <form onSubmit={submitShipment} className="space-y-4 font-outfit">
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setShipmentForm((prev) => ({ ...prev, product_name: e.target.value }))
              }
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setShipmentForm((prev) => ({ ...prev, quantity: Number(e.target.value) || 1 }))
              }
              className="w-full bg-white border border-gray-200 rounded-lg p-2.5 text-sm"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setShipmentForm((prev) => ({ ...prev, product_sku: e.target.value }))
              }
              className="w-full bg-white border border-gray-200 rounded-lg p-2.5 text-sm"
              placeholder="SKU-xyz"
            />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setShipmentForm((prev) => ({ ...prev, recipient_name: e.target.value }))
              }
              className="w-full bg-white border border-gray-200 rounded-lg p-2.5 text-sm"
            />
          </div>
        ...
        <div className="space-y-2 bg-gray-50/50 p-4 rounded-xl border border-dashed border-gray-200">
          <h4 className="text-[10px] font-bold uppercase tracking-wider text-gray-700 pb-1">
            Delivery Address
          </h4>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 sm:col-span-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_address_line1: e.target.value }))
                }
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_address_line2: e.target.value }))
                }
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 font-outfit"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_city: e.target.value }))
                }
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 font-outfit"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_state: e.target.value }))
                }
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 font-outfit"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_zip: e.target.value }))
                }
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 font-outfit"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setShipmentForm((prev) => ({ ...prev, shipping_country: e.target.value }))
                }
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary-500 font-outfit"
              />
            </div>
