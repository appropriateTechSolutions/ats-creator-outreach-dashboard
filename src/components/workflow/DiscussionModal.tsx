...
export function DiscussionModal({ isOpen, onClose, onSubmit, creator, submitting }: DiscussionModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Start Discussion">
      <form onSubmit={handleSubmit} className="space-y-4 font-outfit">
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block">Subject Line</label>
          <input
            type="text"
            className="w-full text-sm font-medium border border-gray-200 rounded-lg p-2.5 focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
            value={subject}
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block">Email Body</label>
          <textarea
        ...
        <div className="flex gap-3 pt-4 border-t border-gray-100">
          ...
          <Button type="submit" disabled={submitting || generating || !subject || !body || !toEmail} className="flex-1 bg-primary-600 hover:bg-primary-700 text-white font-normal text-xs uppercase tracking-widest flex items-center justify-center gap-2">
