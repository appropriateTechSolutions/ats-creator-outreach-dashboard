      ...
      <CardContent className="space-y-4">
        {templateSubject || templateBody ? (
          <div className="space-y-3">
            <div>
              <div className="text-[10px] font-normal text-gray-400 uppercase tracking-widest mb-1">
                Subject
              </div>
          ...
          <div className="text-center py-6 px-4 bg-white/60 border border-dashed border-primary-200 rounded-lg">
            ...
            <p className="text-[11px] text-gray-400">
              Draft one with AI, or click Edit to write from scratch.
            </p>
          </div>
        )}

        {hasRole(currentUserRole, ROLE_GROUPS.MANAGE_CREATORS) && (
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-gray-400 text-center italic">
              AI uses this campaign's brand, offer, and audience to draft the email. Review in the
              editor and save when you're happy.
            </p>
          </div>
        )}
      </CardContent>
