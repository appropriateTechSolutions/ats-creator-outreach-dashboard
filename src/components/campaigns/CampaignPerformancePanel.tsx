      ...
      <div className="p-6 space-y-8 bg-white rounded-b-[12px]">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">
              Aggregate views, engagement, costs, and conversion funnel
            </p>
          </div>
          <Button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
            ...
            <div className="text-xl font-normal text-gray-900 font-outfit mt-1">
              {perfData?.total_views ? formatFollowers(perfData.total_views) : 0}
            </div>
          </div>
          <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
            <div className="text-[10px] font-normal text-gray-500 uppercase tracking-widest">
            ...
            <div className="text-xl font-normal text-gray-900 font-outfit mt-1">
              {perfData?.total_engagement ? formatFollowers(perfData.total_engagement) : 0}
            </div>
          </div>
          <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
            <div className="text-[10px] font-normal text-gray-500 uppercase tracking-widest">
            ...
            <div className="text-xl font-normal text-gray-900 font-outfit mt-1">
              {perfData?.avg_engagement_rate || '0.00'}%
            </div>
          </div>
          <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
            <div className="text-[10px] font-normal text-gray-500 uppercase tracking-widest">
          ...
          <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100">
            ...
            <div className="text-xl font-normal text-gray-900 font-outfit mt-1">
              {perfData?.roi !== null && perfData?.roi !== undefined
                ? `${Number(perfData.roi).toFixed(2)}x`
                : 'N/A'}
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-6">
          ...
          <div className="space-y-4 max-w-2xl">
            {[
              ...
              const pct =
                funnelData?.identified > 0 ? Math.round((val / funnelData.identified) * 100) : 0;
              return (
                <div key={stage.key} className="flex items-center gap-4">
                  <div className="w-44 text-xs font-normal text-gray-500 uppercase tracking-wider text-right">
                    {stage.label}
                  </div>
    ...
    return (
      <div className="p-6 space-y-6 bg-white rounded-b-[12px]">
        <div>
          ...
          <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">
            Real-time log of creator outreach, approvals, shipments, and content updates
          </p>
        </div>
        ...
        {activities.length === 0 ? (
          ...
          <div className="relative border-l border-gray-150 ml-4 pl-6 space-y-6 mt-4">
            {activities.map((act) => {
              const timeStr =
                act.created_at || act.createdAt
                  ? format(new Date(act.created_at || act.createdAt), 'MMM d, yyyy h:mm a')
                  : 'N/A';
                ...
                <div key={act.id} className="relative group">
                  ...
                  <div>
                    <div className="flex items-center gap-3">
                      <span className="text-xs font-bold text-gray-900 font-outfit uppercase tracking-wider">
                        {act.title}
                      </span>
