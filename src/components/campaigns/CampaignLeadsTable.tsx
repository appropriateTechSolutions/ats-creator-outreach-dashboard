...
import { ChevronDown, Loader2, Activity, Sparkles, Check, X, Star, Instagram, Youtube } from 'lucide-react';
            ...
            {pagedLeads.map(lead => (
              <Tr key={lead.id}>
                ...
                <Td className="text-right">
                  {['super_admin', 'admin', 'operator', 'client_admin', 'client_marketing'].includes(userRole) && (
