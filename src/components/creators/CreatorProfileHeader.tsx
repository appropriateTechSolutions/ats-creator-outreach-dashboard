...
import { 
  ArrowLeft, ExternalLink, Instagram, Youtube, Activity,
  Check, X, Star, Users, RefreshCw, Send, Clock
} from 'lucide-react';
            ...
            <div className="min-w-0">
               ...
               <div className="mt-1">
                 <a 
                  href={
                    (() => {
                      const igProfile = creator.profiles?.find((p: any) => p.platform.toLowerCase() === 'instagram');
              ...
              <div className="flex flex-wrap gap-4 mt-3">
                {creator.has_instagram && (
                  <a 
                    href={creator.profiles?.find((p: any) => p.platform.toLowerCase() === 'instagram')?.profile_url || `https://instagram.com/${creator.handle?.replace(/^@/, '')}`} 
                    target="_blank" 
                    rel="noreferrer" 
                ...
                {creator.has_youtube && (
                  <a 
                    href={creator.profiles?.find((p: any) => p.platform.toLowerCase() === 'youtube')?.profile_url || `https://youtube.com/@${creator.handle?.replace(/^@/, '')}`} 
                    target="_blank" 
                    rel="noreferrer" 
                ...
                {creator.has_tiktok && (
                  <a 
                    href={creator.profiles?.find((p: any) => p.platform.toLowerCase() === 'tiktok')?.profile_url || `https://tiktok.com/@${creator.handle?.replace(/^@/, '')}`} 
                    target="_blank" 
                    rel="noreferrer" 
