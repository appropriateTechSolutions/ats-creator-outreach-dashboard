      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 space-y-5 overflow-y-auto">
          <div className="space-y-1">
            <label
              htmlFor="templateeditmodal-1"
              className="text-[10px] font-normal text-gray-500 uppercase tracking-widest"
            >
              Email Subject
            </label>
            <input
              id="templateeditmodal-1"
              type="text"
              value={subject}
          ...
          <div className="space-y-1">
            <label
              htmlFor="templateeditmodal-2"
              className="text-[10px] font-normal text-gray-500 uppercase tracking-widest"
            >
              Message Body
            </label>
            <textarea
              id="templateeditmodal-2"
              rows={14}
              value={body}
            ...
            <p className="text-[10px] text-gray-400 italic">
              Plain text — line breaks are preserved in the sent email.
            </p>
          </div>
